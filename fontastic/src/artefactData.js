...
const artefactData = [
  ...
  },
  {
    ...
    learningText1:
      "Am Beispiel der Alten Universität lässt sich die Rolle der Einbindung von beschriebenen Objekten in ihre Umgebung beschreiben. Dies geschieht durch die Beobachtung der räumlichen Gegebenheit (Topographie), sowie der Art und Weise auf welchen Wegen und auf welche Weise bestimmte Menschen mit Artefakten in Berührung kommen (Topologie).",
    learningText2:
      "Betrachtet man also die Einbindung der Alten Universität und der Alten Aula in das moderne Universitätsleben, so zeigt eine topographische Analyse, dass sie sich gut zugänglich am Universitätsplatz und zentral in der Heidelberger Altstadt befinden. Man könnte sie somit praktisch und symbolisch als Kern der Einrichtung vermuten.",
    learningText3:
  ...
  },
  {
    ...
    learningText1:
      "Ein Gegenstand gewinnt erst dann Bedeutung, wenn wir Menschen mit ihn wahrnehmen, einordnen und daraufhin mit ihm interagieren. Am Beispiel von schrifttragenden Artefakten bedeutet dies stehen zu bleiben, die Schrift zu lesen, sie zu verarbeiten, uns die Botschaft zu merken, wenn wir sie als wichtig erachten und anschließend vielleicht sogar anderen davon zu erzählen. Genauso kann aber auch eine negative Reaktion, nämlich das ignorieren oder übersehen von Schriften eine Praktik sein. Heutzutage sind wir von zahlreichen Schriften umgeben, sodass sie uns alltäglich erscheinen. Sie konkurrieren um unsere Aufmerksamkeit.",
    learningText2:
      "Bezogen auf das Beispiel der Stolpersteine war die ursprüngliche Idee des Künstlers, dass sie durch das Hinwegschreiten der Passanten blankpoliert werden und sich so von der Umgebung abheben. Tatsächlich weichen ihnen viele Menschen jedoch aus Respekt aus, weswegen sie durch die Zeit anlaufen. Aus diesem Grund werden im Rahmen von Erinnerungsveranstaltungen Initiativen organisiert, um die Stolpersteine zu putzen. ",
    learningText3:
